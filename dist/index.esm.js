...
var Icon$22 = function (props) { return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
...
var Icon$1j = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("image", { width: "32", height: "32", href: "/images/LogoTextNewDark.png" })));
};
...
var Icon$i = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 256 256" }, props),
        React.createElement("image", { width: "256", height: "256", href: "/images/LogoTextNewDark.png" })));
};

var Icon$h = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 128 128" }, props),
        React.createElement("image", { width: "128", height: "128", href: "/images/LogoTextNewDark.png" })));
};
...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "rgb(60, 55, 66)", backgroundDisabled: "rgb(60, 55, 66)", backgroundAlt: "rgb(18, 24, 39)", cardBorder: "rgb(82, 75, 99)", contrast: "#191326", dropdown: "rgb(44, 90, 158)", dropdownDeep: "#EEEEEE", invertedContrast: "#5c8fdd", input: "#121827", inputSecondary: "#d7caec", tertiary: "rgb(60, 55, 66)", text: "rgb(10, 171, 243)", textDisabled: "#BDC2C4", textSubtle: "rgb(92, 143, 221)", disabled: "rgb(60, 55, 66)", gradients: {
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#9A6AFF", background: "#1f2b46", backgroundDisabled: "#3c3742", backgroundAlt: "#27262c", cardBorder: "#524B63", contrast: "#5c8fdd", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#191326", input: "#483f5a", inputSecondary: "#262130", primaryDark: "#0098A1", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#5c8fdd", disabled: "#524B63", gradients: {
...
var ModalBackButton = function (_a) {
    ...
    return (React.createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
        React.createElement(Icon$20, { color: "primary" })));
};
...
var Logo$2 = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 220 50" }, props),
        React.createElement("image", { width: "100", height: "50", href: isDark ? '/images/LogoTextNewDark.png' : '/images/LogoTextNewDark.png' })));
};
...
var Logo = function (_a) {
    ...
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "0px" }, isPushed ? (React.createElement(Icon$d, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$e, { width: "24px", color: "textSubtle" }))),
        isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href, "aria-label": "StakesMoon home page" }, innerLogo)) : (React.createElement(StyledLink, { to: href, "aria-label": "StakesMoon home page" }, innerLogo))));
};
...
var socials = [
    {
        label: "Telegram",
        icon: "TelegramIcon",
        href: "https://t.me/StakeMoonOfficial",
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/stakecoins",
    },
];
var MENU_HEIGHT = 64;
...
var Accordion = function (_a) {
    ...
    return (React.createElement(Container$2, null,
        React.createElement(MenuEntry, { onClick: handleClick, className: className, isActive: isActive, role: "button" },
            ...
            isOpen ? React.createElement(Icon$1Z, null) : React.createElement(Icon$1_, null)),
...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav; _a.toggleTheme; _a.isDark; var cakePriceUsd = _a.cakePriceUsd, priceLink = _a.priceLink; _a.currentLang; _a.langs; _a.setLang;
    if (!isPushed) {
    ...
    return (React.createElement(Container, null,
        React.createElement(SocialEntry, null,
            React.createElement(CakePrice$1, { cakePriceUsd: cakePriceUsd, priceLink: priceLink }),
...
var Menu$1 = function (_a) {
    var userMenu = _a.userMenu; _a.globalMenu; var isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, cakePriceUsd = _a.cakePriceUsd, priceLink = _a.priceLink, links = _a.links, children = _a.children;
    ...
    return (React.createElement(Wrapper, null,
        ...
        React.createElement(BodyWrapper, null,
            React.createElement(Panel, { isPushed: isPushed, isMobile: isSmallerScreen, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, priceLink: priceLink, pushNav: setIsPushed, links: links }),
